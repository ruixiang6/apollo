...
static int8_t dbg_buf[DBG_BUF_SIZE];

void plat_dbg_print(uint8_t level, const int8_t *fn, uint16_t line, ...)
{
	const int8_t *fmt;
	int8_t *pbuf = dbg_buf;
...
void plat_dbg_assert(const int8_t *cond, const int8_t *fn, uint16_t line)
{
	int8_t *pbuf = dbg_buf;
