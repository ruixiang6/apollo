...
void piclib_draw_hline(u16 x0,u16 y0,u16 len,u16 color)
{
	...
	hal_lcd_fill(x0,y0,x0+len-1,y0,color);	
}
//填充颜色
//x,y:起始坐标
//width，height：宽度和高度。
...
{  
	...
	}else hal_lcd_color_fill(x,y,x+width-1,y+height-1,color);//其他情况,直接填充	
}
//////////////////////////////////////////////////////////////////////////
...
{
	pic_phy.read_point=hal_lcd_read_point;  		//读点函数实现,仅BMP需要
	pic_phy.draw_point=hal_lcd_draw_color_point;	//画点函数实现
	pic_phy.fill=hal_lcd_fill;					//填充函数实现,仅GIF需要
